...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_Header__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_cefc_ui_icon__ = __webpack_require__(9);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        __WEBPACK_IMPORTED_MODULE_1__src_Header__["a" /* default */],
        null,
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          __WEBPACK_IMPORTED_MODULE_1__src_Header__["a" /* default */].Left,
          null,
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_cefc_ui_icon__["a" /* default */], { type: 'return', color: 'white' })
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          __WEBPACK_IMPORTED_MODULE_1__src_Header__["a" /* default */].Title,
          null,
          '\u8BC1\u5238\u4EA4\u6613'
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          __WEBPACK_IMPORTED_MODULE_1__src_Header__["a" /* default */].Right,
          null,
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_cefc_ui_icon__["a" /* default */], { type: 'homepage', color: 'white', size: 'lg', onClick: handleClickHome }),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_cefc_ui_icon__["a" /* default */], { type: 'refresh', color: 'white', size: 'lg', onClick: handleClickRefresh })
        )
      );
    }
  }]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_cefc_ui_icon__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__style_index_less__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__style_index_less___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__style_index_less__);
...
var defaultPrefixCls = 'cefc-header';
...
function HolderBuilder(name, id) {
  function Holder(_ref) {
    ...
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'div',
      { className: name ? prefixCls + '-' + name : prefixCls, id: id },
      children
    );
  }
...
var Header = HolderBuilder(null, 'header');
var Title = HolderBuilder('title');
var Right = HolderBuilder('right');
...
function Left(_ref2) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    'div',
    { className: prefixCls + '-left', onClick: onBack },
    children
  );
}
...
Left.defaultProps = {
  prefixCls: defaultPrefixCls,
  children: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_cefc_ui_icon__["a" /* default */], { type: 'return' }),
...
Left.propTypes = {
  prefixCls: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string.isRequired,
  children: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.node.isRequired,
  onBack: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func
};
...
// module
exports.push([module.i, ".cefc-header{position:fixed;width:100%;top:0;left:0;display:flex;flex-direction:row;align-items:stretch;background-color:#404040;color:#fff}.cefc-header-left,.cefc-header-right,.cefc-header-title{display:flex;flex-direction:row;align-items:center;box-sizing:border-box}.cefc-header-title{flex:3;white-space:nowrap;text-overflow:ellipsis;font-size:17px;justify-content:center;padding-top:6px;padding-bottom:6px;min-height:44px}.cefc-header-left,.cefc-header-right{margin-left:8px;margin-right:8px;font-size:15px;flex:1}.cefc-header-left{justify-content:flex-start}.cefc-header-right{justify-content:flex-end}", ""]);
